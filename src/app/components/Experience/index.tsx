    ...
    <section id="experience" className="min-h-screen py-24 bg-white flex items-center justify-center">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-10 text-red-300 text-center">Professional Experience</h2>
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row items-center mb-16">
                <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 md:text-right">
                  <h3 className="text-xl font-bold md:text-2xl">Principal Valuation Surveyor</h3>
              ...
              <div className="flex flex-col md:flex-row items-center mb-16">
                <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 md:text-right">
                  <h3 className="text-xl font-bold md:text-2xl">Lecturer</h3>
              ...
              <div className="flex flex-col md:flex-row items-center mb-16">
                <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 md:text-right">
                  <h3 className="text-xl font-bold md:text-2xl">Valuation Surveyor</h3>
