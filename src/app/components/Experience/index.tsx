          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row items-center mb-16">
                <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 md:text-right">
                  <h3 className="text-xl text-gray-800 font-bold md:text-2xl">Arbitrator</h3>
                ...
                <div className="md:w-1/2 md:pl-16">
                  <p className="text-gray-700 md:text-lg">Resolving various arbitrable disputes in land, real estate and commercial sector.</p>
                </div>
              </div>
              <div className="flex flex-col md:flex-row items-center mb-16">
                <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 md:text-right">
